...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<?php $this->load->view("kepala/_front/sidebar.php") ?>

		<div id="content-wrapper">

			<div class="container-fluid">

				<?php $this->load->view("kepala/_front/breadcrumb.php") ?>
				<div class="row">
					<div class="col-lg-12 col-md-12 col-xs-12">
						<div class="row">
							...
							<div class="col-md-4 text-right">
								<a href="<?php echo site_url('kepala/laporan/print_doc'); ?>" target="_blank" class="btn btn-dark">Cetak</a>
		...
		<table class="table table-striped table-bordered">
			...
			<!-- Sticky Footer -->
			<?php $this->load->view("kepala/_front/footer.php") ?>
